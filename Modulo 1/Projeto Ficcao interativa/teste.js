...
// testaEscolha_2(esc1);//alterar parametro para a escolha desejada
...
function testaEscolha_3(a){
    ...
    while(escolha > 3 || escolha < 1 ){
        ...
        if(escolha > 2 || escolha < 1 ){
                console.log('Para escolher digite apenas 1, 2 ou 3');
...
//testaEscolha_3(esc1);//alterar parametro para a escolha desejada
...
/////////////////////////
/////////////////////////
// testar pois esta aparentemente funcionando:
