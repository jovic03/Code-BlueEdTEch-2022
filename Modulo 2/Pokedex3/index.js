...
const __dirname = path.resolve(path.dirname(''))//informa a pasta raiz do projeto

const app =express()
app.set('view engine', 'ejs')//tudo que for ejs dentro da pasta views seja renderizado

app.use(express.static(path.join(__dirname,'public'))) //pra usar os complementos estaticos (img, css, js)---leia a views e a pasta public
